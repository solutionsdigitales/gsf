...
const IGNORED_COLUMNS = [
  'uuid', 'invoice_uuid', 'entity_uuid', 'reference_uuid',
  'record_uuid', 'debtor_uuid', 'location_uuid', 'document_uuid',
];
...
function render(data, filename, options) {
  ...
  let displayNames = (options.renameKeys) ? options.displayNames : {};
