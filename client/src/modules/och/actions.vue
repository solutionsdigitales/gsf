...
export default defineComponent({
  ...
  methods: {
    ...
    closeDialog(result) {
      if (result) {
        this.$emit("reloadVoucherList", true);
      }
      this.display = false;
    ...
    DeletionConfirmDialog(result) {
      ...
      OCHService.delete(this.entity.uuid)
        .then(() => {
    ...
    setItems() {
      ...
      listActions.push({
        ...
        command: () => {
          ...
          const fileName = OCHService.getFileName(this.entity);
          OCHService.dowloadPdf(uri, fileName);
        },
      },
      {
          label: "CSV",
          ...
          command: () => {
            OCHService.exportCSV(this.entity.uuid).then((data) => {
      ...
      listActions.push({
        ...
        command: () => {
          this.$router.push({
            ...
            query: { voucherUuid: this.entity.uuid, clone: 1 },
          });
        },
      });
