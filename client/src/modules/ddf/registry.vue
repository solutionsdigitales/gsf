...
export default defineComponent({
  ...
  created() {
    ...
    this.filters = DDFservice.filters;
  ...
  methods: {
    viewPDF(ta) {
      ...
      this.fileName = DDFservice.getFileName(ta);
    ...
    downloadExcel() {
      ...
      const getParams = DDFservice.serelize(params);
      const uri = `${this.server}frs/download/excel?lang=${this.lang}&${getParams}`;
