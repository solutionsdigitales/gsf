p-button p-component p-button-secondary<template>
  <Dialog
    v-if="display"
    :header="$t('TREE.BUDGET_LINE') + '/' + $t('FORM.LABELS.IMPORTING')"
    :closable="false"
    position="top"
    :style="{ width: '30vw' }"
    :modal="true"
  ...
  >
    <div class="col-p12" style="margin-top: 10px">
      <div class="download-template">
        ...
        <a href="/templates/budget_line.xlsx" download="bugetLines">
...
export default defineComponent({
  ...
  methods: {
    ...
    submit() {
      ...
      fd.append("location", "Kinshasa");
      this.loading = true;
      BudgetLineService.import(fd)
        .then(() => {
