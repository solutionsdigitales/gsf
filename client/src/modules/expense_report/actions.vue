...
import PRFApprovement from "../prf/prf_approvement";
...
export default defineComponent({
  ...
  methods: {
    ...
    DeletionConfirmDialog(result) {
      ...
      ExpenseReportService.delete(this.entity.uuid)
        .then(() => {
    ...
    setItems() {
      ...
      listActions.push({
        ...
        command: () => {
          ...
          const fileName = ExpenseReportService.getFileName(this.entity);
          ExpenseReportService.dowloadPdf(uri, fileName);
        },
      });
